        ...
        with gr.Blocks(theme=self.theme) as multi_provider_ui:
            ...
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    generate_btn = gr.Button(
                        "Generate with Multiple Providers", variant="primary"
                    )
            ...
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    generate_tasks_btn = gr.Button(
                        "Generate Tasks with Multiple Providers", variant="primary"
                    )
