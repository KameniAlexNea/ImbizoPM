...
class AnthropicConfig(ProviderConfig):
    ...
    models = [
        ...
        ModelInfo(name="claude-3-opus-20240229", context_length=200000, is_default=True)
    ]
...
class ModelConfigManager:
    ...
    def __init__(self, env_file: Optional[str] = None):
        ...
        self.ollama = OllamaConfig(base_url=os.environ.get("OLLAMA_BASE_URL", "http://localhost:11434"))
