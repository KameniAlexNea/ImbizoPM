...
class TestProjectGenerator(unittest.TestCase):
    ...
    def test_generate_project_description(self):
        ...
        description = self.generator.generate_project_description("Create a task manager app")
    ...
    def test_interactive_project_creation(self, mock_print, mock_input):
        ...
        project_data, issues = self.generator.interactive_project_creation("Create a task manager")
