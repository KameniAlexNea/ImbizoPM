...
class TestConfig(unittest.TestCase):
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test_openai_key", "OPENAI_MODEL": "gpt-4-turbo"})
    ...
    @patch.dict(os.environ, {"ANTHROPIC_API_KEY": "test_anthropic_key", "ANTHROPIC_MODEL": "claude-3-haiku"})
    ...
    @patch.dict(os.environ, {"OLLAMA_BASE_URL": "http://custom:1234", "OLLAMA_MODEL": "mistral"})
