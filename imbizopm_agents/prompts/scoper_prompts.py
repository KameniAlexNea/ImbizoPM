...
4. Optionally, define a phased delivery approach beyond the MVP. List these phases, each described as a string outlining its focus or key deliverables. The first phase description should typically correspond to the MVP. If no phased approach is defined beyond the MVP, indicate this according to the specified format.
...
- If defining delivery phases, ensure the descriptions represent logical increments of value, building upon previous phases.
...
- Ensure consistency between the defined MVP items, the exclusions, and the description of the first phase (if phases are defined).
"""
